...
class Usuario(models.Model):
	#Tupla con los diferentes tipos de usuario
	TIPO_CHOICES = (
		(1, 'DOCENTE'),
		(2, 'DIRECTOR'),
		(3, 'ALUMNO')
...
class Curso(models.Model):
	...
	docente = models.ForeignKey('Usuario') # Variable que guarda el id del usuario (Solo puede ser DOCENTE)
...
class Comentario_Aviso(models.Model):
	usuario = models.ForeignKey('Usuario') # Variable que almacena el id del Usuario que comenta
...
class Comentario_Tarea(models.Model):
	usuario = models.ForeignKey('Usuario') # Variable que almacena el id del uasuario que comenta la tarea
	texto = models.TextField() # Variable que almacena el comentario del usuario
...
class Lista(models.Model):
	...
	usuario = models.ForeignKey('Usuario') # Variable que almacena el id del alumno
